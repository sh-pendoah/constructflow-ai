...
router.post(
  ...
  async (req: AuthRequest, res: Response) => {
    try {
      ...
      const blobName = azureBlobStorageService.generateBlobName(
      ...
      const { blobUrl } = await azureBlobStorageService.uploadFile({
        ...
        metadata: {
          ...
          projectId: Array.isArray(req.params.projectId)
      ...
      logger.info(
        `Document uploaded to blob storage: ${containerName}/${blobName}`
      );
