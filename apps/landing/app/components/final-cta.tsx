    ...
    <section className="relative w-full py-[120px] bg-[#1B232A] overflow-hidden">
      ...
      <div className="max-w-[1100px] mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#1F6F66] text-white text-base font-bold px-10 py-4 rounded-xl shadow-lg shadow-teal-900/50 hover:bg-[#185A52] hover:-translate-y-1 transition-all duration-300">
              Start 14-Day Free Trial
              <ArrowRight size={18} />
            </button>
            <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-transparent border border-white/20 text-white text-base font-bold px-10 py-4 rounded-xl hover:bg-white/10 transition-all duration-300">
              Schedule a Demo
            </button>
          </motion.div>
