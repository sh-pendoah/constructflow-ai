    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#E9ECEF]">
      <div className="max-w-[1200px] mx-auto px-10 h-[80px] flex items-center justify-between">
        ...
        >
          ...
          <Link href="/auth">
          <button
            className="h-[44px] px-8 cursor-pointer bg-[#1F6F66] text-white text-[15px] font-medium rounded-[6px] hover:bg-[#185A52] transition-all duration-200 flex items-center gap-2"
            style={{
              fontFamily: "Poppins, sans-serif",
              fontWeight: 500,
            }}
