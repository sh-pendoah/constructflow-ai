...
// Simple text-based logo placeholders to simulate the look of company logos
const LogoPlaceholder = ({ name }: { name: string }) => (
  <div className="flex items-center justify-center grayscale opacity-60 hover:opacity-100 transition-opacity duration-300 cursor-default">
    <span className="text-xl md:text-2xl font-bold text-[#1B232A] flex items-center gap-2">
      {/* Abstract Icon */}
      <div className="w-6 h-6 bg-[#1B232A] rounded-sm opacity-80"></div>
      {name}
    </span>
  </div>
);
