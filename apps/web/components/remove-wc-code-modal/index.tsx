...
interface RemoveWCCodeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm?: () => void;
  wcCodeName?: string;
...
const RemoveWCCodeModal: React.FC<RemoveWCCodeModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  wcCodeName,
      ...
      <div className="flex flex-col gap-8 px-11 pt-11 pb-8">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-body-copy text-primary font-sf-pro text-center max-w-[409px]">
            Are you sure you want to Remove this WC Code?
          </p>
        </div>
...
export default RemoveWCCodeModal;
